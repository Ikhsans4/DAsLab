...
<div class="d-flex justify-content-center" style="margin-top: 12rem">
    <form action="{{ url('/admin/dashboard') }}" method="get">@csrf
        ...
        <div class="mb-3">
            ...
            <input type="tel" class="form-control r-10" id="npm" name="npm" placeholder="NPM" style="width: 400px;" autofocus required>
        </div>
        <div class="mb-3">
            <label for="password" class="form-label">Password</label>
            <input type="password" class="form-control r-10" id="password" name="password" placeholder="Password" required>
        </div>
